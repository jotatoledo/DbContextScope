...
namespace EntityFrameworkCore.DbContextScope
{
    ...
    {
        /// <summary>
        /// Gets the context instances that this DbContextScope manages. Don't call SaveChanges() on the DbContext themselves!
        ...
        /// </summary>
        /// <returns>The total of elements affected across all context instances</returns>
        int SaveChanges();
        ...
        /// <returns>A task that resolves to the total of elementsa affected across all context instances</returns>
        ...
        /// </summary>
        /// <param name="entities">The entities to refresh</param>
        /// <returns>A task that wraps the operation</returns>
