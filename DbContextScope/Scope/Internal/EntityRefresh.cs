...
namespace EntityFrameworkCore.DbContextScope.Internal
{
    ...
    internal sealed class EntityRefresh
    {
        ...
        public void Refresh<TEntity>(TEntity toRefresh)
        {
            ...
            var stateInCurrentScope = this.contextInCurrentScope.ChangeTracker
                .GetInfrastructure()
            ...
            if (stateInCurrentScope != null)
            {
                ...
                var stateInParentScope = this.correspondingParentContext.ChangeTracker
                    .GetInfrastructure()
                ...
                if (stateInParentScope != null)
                {
                    ...
                    {
                        this.correspondingParentContext.Entry(stateInParentScope.Entity).Reload();
                    }
                }
            }
#elif NET45 || NET46
            ...
            // We need this EntityKey in order to check if this entity has
            // already been loaded in the parent DbContext's first-level cache (the ObjectStateManager).
            var objectContext = (this.contextInCurrentScope as IObjectContextAdapter).ObjectContext;
